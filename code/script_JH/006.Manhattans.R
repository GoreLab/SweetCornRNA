...
res.twas <- read.csv("./output/NoHarvDate/9.7-TWAS_mutant_type/TwasResult_toco_B73_endosperm.mutation.csv") %>%  # no harvest date B73 all traits all genes
...
ggsave(kernel_manhattan, filename = "./output/NoHarvDate/9.8-MakeManhattan_kernel_mutant_type/ggplot_manhattan_B73_toco.png",
       device = "png",

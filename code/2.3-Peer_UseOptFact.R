...
# file I/O
file.input <- paste0("RESULT/1.3-BLUE/expression_BLUE_final_", ver, "_", ref, ".csv")
file.out.pdf <- paste0("RESULT/2.3-Peer_UseOptFact/PeerResult_UseOptFact_", ver, "_", ref, "_K=", K, "_plotModel.pdf")
file.out.factors <- paste0("RESULT/2.3-Peer_UseOptFact/PeerResult_UseOptFact_", ver, "_", ref, "_K=", K, "_factors.txt")
file.out.weights <- paste0("RESULT/2.3-Peer_UseOptFact/PeerResult_UseOptFact_", ver, "_", ref, "_K=", K, "_weights.txt")
file.out.precision <- paste0("RESULT/2.3-Peer_UseOptFact/PeerResult_UseOptFact_", ver, "_", ref, "_K=", K, "_precision.txt")
file.out.residuals <- paste0("RESULT/2.3-Peer_UseOptFact/PeerResult_UseOptFact_", ver, "_", ref, "_K=", K, "_residuals.txt")
file.out.seed <- paste0("RESULT/2.1-Peer_Use25Fact/PeerResult_Use25Fact_", ver, "_", ref, "_seed.txt")

# mkdir
dir.create("RESULT/2.3-Peer_UseOptFact")

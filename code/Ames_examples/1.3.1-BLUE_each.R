...
foldername.save <- paste0("RESULT/1.3-BLUE/ResEach_", ver, "_", ref)
filename.save.1 <- paste0("RESULT/1.3-BLUE/ResEach_", ver, "_", ref, "/exp_BLUE_all_", s, ".Rdata")
filename.save.2 <- paste0("RESULT/1.3-BLUE/ResEach_", ver, "_", ref, "/exp_BLUE_pred_", s, ".Rdata")
filename.save.3 <- paste0("RESULT/1.3-BLUE/ResEach_", ver, "_", ref, "/exp_BLUE_lastm_", s, ".Rdata")
filename.save.4 <- paste0("RESULT/1.3-BLUE/ResEach_", ver, "_", ref, "/exp_BLUE_seed_", s, ".txt")
